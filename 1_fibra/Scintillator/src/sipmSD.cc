...
// ********************************************************************
//
// $Id: sipmSD.cc 87359 2014-12-01 16:04:27Z gcosmo $
...
{
  collectionName.insert("HitsCollectionSiPMs");
  //hcID=-1;
}
...
if ( aStep->GetTrack()->GetDefinition()== G4OpticalPhoton::OpticalPhotonDefinition()) {
  ...
  newHit->SetsipmNb(aStep->GetPostStepPoint()->GetTouchableHandle()
                                               ->GetCopyNumber());
...
G4double TotalEnergy=0;
 // if ( verboseLevel>1 )
  //{
     ...
     TotalEnergy = TotalEnergy + (*fHitsCollection)[i] ->GetEnergy();
     }

     G4cout << "Final energy: " << TotalEnergy << G4endl;
