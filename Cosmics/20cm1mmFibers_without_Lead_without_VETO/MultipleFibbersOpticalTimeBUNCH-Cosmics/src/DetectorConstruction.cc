...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
    ...
    G4double worldExt=50*cm;//use 50cm as the Cry plan was choosed to have 1m side
    ...
    //world volume
    G4VSolid* worldSolid = new G4Box("worldBox",worldExt,worldExt,2.5*halfTeflonLength);
    ...
    //Make Air Box
    G4VSolid* airBoxSolid = new G4Box("airBoxSolid",worldExt,worldExt,2.5*halfTeflonLength);
