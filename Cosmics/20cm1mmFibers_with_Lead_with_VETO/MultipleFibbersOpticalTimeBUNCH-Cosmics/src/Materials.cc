98*cm,2247.19*cm,2331.00*cm,2364.07*cm,2341.92*cm,2444.99*cm,2403.85*cm,2444.99*cm,2475.25*cm,2590.67*cm,2717.39*cm,2865.33*cm,3039.51*cm,3225.81*cm,3436.43*cm,3663.00*cm,3921.57*cm,4201.68*cm,4484.30*cm,4784.69*cm,5050.51*cm,5291.01*cm,5524.86*cm,5747.13*cm,5988.02*cm,6172.84*cm,6369.43*cm,6578.95*cm,6756.76*cm,6944.44*cm,7092.20*cm,7246.38*cm,7407.41*cm,7518.80*cm,7692.31*cm,7812.50*cm,7936.51*cm,8064.52*cm,8196.72*cm,8333.33*cm,8474.58*cm,8620.69*cm,8771.93*cm,8928.57*cm,9090.91*cm,9259.26*cm,9433.96*cm,9615.38*cm,9803.92*cm,10101.01*cm,10309.28*cm,10638.30*cm,10869.57*cm,11235.96*cm,11494.25*cm,11904.76*cm,12195.12*cm,12658.23*cm,13157.89*cm,13513.51*cm,13888.89*cm,14492.75*cm,14925.37*cm,15384.62*cm,15873.02*cm,16393.44*cm,16949.15*cm,17241.38*cm,17857.14*cm};
    ...
    //IN ORDER TO TRICK THE SOFTWARE (AS WE ARE KNOW CONSIDERING THE WORLD AS AIR), LETS GIVE THE WATER PROPERTIES TO AIR IN ORDER TO HAVE THE OPTICAL PART WORKING.
    //SO, THE ONLY DIFFERENCE IS WE CONSIDER THE AIR INSIDE THE TEFLON LIKE WATER PROPERTIES. OTHERELSE ONE SHOULD BUILD A WATER VOLUME

    //    fAir->SetMaterialPropertiesTable(mptWater);
    ...
    */
    ...
    // Add entries into properties table
    G4MaterialPropertiesTable* mptPolystyrene2 = new G4MaterialPropertiesTable();
    mptPolystyrene2->AddProperty("RINDEX",photonEnergyPS,refractiveIndexPS,nEntriesPS);//checked
    mptPolystyrene2->AddProperty("ABSLENGTH",photonEnergyAbsorption,absPS,nEntriesAbsorption);//checked
    mptPolystyrene2->AddProperty("FASTCOMPONENT",photoEmissionEnergy, scintilFast,nEntriesFastComp);//checked
    mptPolystyrene2->AddConstProperty("SCINTILLATIONYIELD",10./keV);//checked
    mptPolystyrene2->AddConstProperty("RESOLUTIONSCALE",0.0);//TO MEASURE
    mptPolystyrene2->AddConstProperty("FASTTIMECONSTANT", 2.4*ns);	//checked

    fPolystyrene2->SetMaterialPropertiesTable(mptPolystyrene2);

    // Set the Birks Constant for the Polystyrene scintillator

    fPolystyrene2->GetIonisation()->SetBirksConstant(0.126*mm/MeV);//checked
